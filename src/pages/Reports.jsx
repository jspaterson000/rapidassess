...
import { FileText, Calendar, User as UserIcon, Briefcase } from 'lucide-react';
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 animate-fade-in-up">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Assessment Reports</h1>
          <p className="text-slate-500 mt-1">View all generated assessment reports.</p>
        </div>
      </div>
