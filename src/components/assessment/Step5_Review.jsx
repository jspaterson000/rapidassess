...
import { ImageIcon, FileText, ArrowLeft, ArrowRight } from 'lucide-react';
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-3 bg-slate-50 rounded-lg">
                <p className="text-sm font-medium text-slate-500 mb-1">Claim Number</p>
                <p className="text-base font-semibold text-slate-800">{job?.claim_number || 'Loading...'}</p>
              </div>
              <div className="p-3 bg-slate-50 rounded-lg">
                <p className="text-sm font-medium text-slate-500 mb-1">Event Type</p>
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
                ...
                <div>
                  <p className="font-semibold text-slate-800">{assessmentData.photos?.length || 0}</p>
              ...
              <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
                ...
                <div>
                  <p className="font-semibold text-slate-800">{assessmentData.documents?.length || 0}</p>
